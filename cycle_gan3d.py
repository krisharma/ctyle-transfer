...
# Local imports
import utils
from data_loader import get_data_loader3d
from models import CycleGenerator3d, PatchGANDiscriminator3d
...
def create_model(opts):
    G_XtoY = CycleGenerator3d(init_zero_weights=opts.init_zero_weights)
    G_YtoX = CycleGenerator3d(init_zero_weights=opts.init_zero_weights)
    D_X = PatchGANDiscriminator3d()
    D_Y = PatchGANDiscriminator3d()
...
def main(opts):
    ...
    dataloader_X, test_dataloader_X = get_data_loader3d(img_type=opts.X, opts=opts)
    dataloader_Y, test_dataloader_Y = get_data_loader3d(img_type=opts.Y, opts=opts)
...
def create_parser():
    ...
    # Data sources
    parser.add_argument('--X', type=str, default='pre_contrast', choices=['pre_contrast', 'post_contrast'], help='Choose the type of images for domain X.')
    parser.add_argument('--Y', type=str, default='flair', choices=['pre_contrast', 'flair'], help='Choose the type of images for domain Y.')
