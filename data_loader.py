...
def get_data_loader2d(img_type, opts):
    ...
    train_path = os.path.join('/home', 'adithya', 'Desktop', 'Adithya', 'Breast_Style_Transfer', 'Dataset', 'Train_{}'.format(img_type))
    test_path = os.path.join('/home', 'adithya', 'Desktop', 'Adithya', 'Breast_Style_Transfer', 'Dataset', 'Test_{}'.format(img_type))
